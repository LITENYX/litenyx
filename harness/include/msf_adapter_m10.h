...
//
// Frozen SPEC-3: M10 = Recovery Time (blocks to return to baseline after shock)
// Authority class: OBSERVATIONAL_ADAPTER

#ifndef MSF_ADAPTER_M10_H
#define MSF_ADAPTER_M10_H
...
public:
    ...
    static constexpr const char* MetricID() { return "M10"; }
    static constexpr const char* MetricName() { return "Recovery Time"; }
