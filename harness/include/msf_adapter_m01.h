...
#ifndef MSF_ADAPTER_M01_H
#define MSF_ADAPTER_M01_H
...
public:
    ...
    static constexpr const char* MetricID() { return "M01"; }
    static constexpr const char* MetricName() { return "Volume"; }
